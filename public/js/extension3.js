class MachineLearningText {
    ...
    constructor() {
        this._labels = [  'positive',  'negative',  ];
    ...
    getInfo() {
        ...
        return {
            ...
            id: 'mlforkidstextf3d686004afb11e9bc7dc918910a18a9',
    ...
    addTraining({ TEXT, LABEL }) {
        ...
        var url = new URL('https://machinelearningforkids.co.uk/api/scratch/0eceaaf0-4afc-11e9-8731-4314a939a1f1cec36a65-68bc-46df-a3c3-6b4e82e51786/train');
...
function classifyText(text, cacheKey, lastmodified, callback) {
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/0eceaaf0-4afc-11e9-8731-4314a939a1f1cec36a65-68bc-46df-a3c3-6b4e82e51786/classify');
...
function trainNewClassifier() {
    ...
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/0eceaaf0-4afc-11e9-8731-4314a939a1f1cec36a65-68bc-46df-a3c3-6b4e82e51786/models');
    var options = {
        headers : {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function fetchStatus() {
    ...
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/0eceaaf0-4afc-11e9-8731-4314a939a1f1cec36a65-68bc-46df-a3c3-6b4e82e51786/status');
    var options = {
        headers : {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
